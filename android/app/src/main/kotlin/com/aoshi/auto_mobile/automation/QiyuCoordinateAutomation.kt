...
object QiyuCoordinateProfile {
    ...
    // 宝箱页分数区域：实测"当前分数"文字块在顶部标题下，数字（金色）在文字正下方。
    // 2位数紧凑框 [477,1290-745,1415]（宽268px 高125px），扩展至能容纳6位数（宽约800px）。
    // 居中分布，横向 x[200,1060]，纵向保持2位数框高度 y[1290,1415]。
    val score = Region(73.0 / 460, 472.0 / 1024, 387.0 / 460, 517.0 / 1024)
    ...
    val viewCount = Region(52.0 / 460, 920.0 / 1024, 190.0 / 460, 985.0 / 1024)
    val openCount = Region(270.0 / 460, 920.0 / 1024, 430.0 / 460, 985.0 / 1024)
    val slots = listOf(
        Point(0.240, 0.689), Point(0.492, 0.689), Point(0.734, 0.689),
        Point(0.240, 0.781), Point(0.492, 0.781),
    )
    // 规则 OCR 区域，每个矩形覆盖对应 slot 正下方的规则文字。
    // 原始坐标（1260×2800）：规则区1 [188,1998-441,2054], 规则区5 [498,2264-753,2309]
    // 换算到 460×1024 基准后按槽位排列推算全部 5 个区域。
    val ruleRegions = listOf(
        Region(69.0 / 460, 731.0 / 1024, 161.0 / 460, 751.0 / 1024),   // slot[0] 下方
        Region(182.0 / 460, 731.0 / 1024, 275.0 / 460, 751.0 / 1024),  // slot[1] 下方
        Region(295.0 / 460, 731.0 / 1024, 388.0 / 460, 751.0 / 1024),  // slot[2] 下方
        Region(69.0 / 460, 828.0 / 1024, 161.0 / 460, 845.0 / 1024),   // slot[3] 下方
        Region(182.0 / 460, 828.0 / 1024, 275.0 / 460, 845.0 / 1024),  // slot[4] 下方
    )
}
